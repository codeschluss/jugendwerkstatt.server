...
public class TemplateApi extends CrudApi<TemplateEntity, TemplateService> {
	...
	public PageableList<TemplateEntity> readAll(@GraphQLArgument(name = CrudApi.params) FilterSortPaginate params) {
		return super.readAll(params);
	}

	@Override
	@GraphQLQuery(name = "getTemplate")
	public Optional<TemplateEntity> readOne(@GraphQLArgument(name = CrudApi.entity) TemplateEntity entity) {
		return super.readOne(entity);
	}

	@Override
	@GraphQLMutation(name = "saveTemplates")
	public List<TemplateEntity> saveAll(@GraphQLArgument(name = CrudApi.entities) List<TemplateEntity> entities) {
