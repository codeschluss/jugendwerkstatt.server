...
('4b88a5c6-cedb-4f73-809d-e042be5b0779', 'superviser', 'Betreuer');

INSERT INTO users (id, approved, fullname, email, password, phone, evaluate_course, verified) VALUES
('28fc7d3a-afc7-49ca-8070-eea8671abab3', true, 'Admin', 'admin@example.com', '$2a$10$FpJxzuxpXKUIDQMuLNARGOb5Ocz2YoiW4WwgWOoM4uaB7P6iNM.SW', '1111111111', false, true);
