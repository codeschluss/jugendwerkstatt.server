...
public class QTestImageEntity extends EntityPathBase<TestImageEntity> {
  ...
  public final app.wooportal.server.test.units.core.entities.base.QTestEntity parent;
  ...
  public QTestImageEntity(Class<? extends TestImageEntity> type, PathMetadata metadata, PathInits inits) {
    ...
    this.parent = inits.isInitialized("parent") ? new app.wooportal.server.test.units.core.entities.base.QTestEntity(forProperty("parent"), inits.get("parent")) : null;
  }
